package com.sunteorum.feelrecord;

import com.sunteorum.feelrecord.R;
...
public class PushRefreshListView extends HandyListView {
	...
	private void init() {
		...
		Time t = new Time();
		t.setToNow();;
		mHtvTime.setText("最后刷新: " + t.format("%Y年%m月%d日  %H:%M:%S"));
